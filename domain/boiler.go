...
const (
	...
	// BoilerStatusIdle 备用（待机）。
	BoilerStatusIdle BoilerStatus = "idle"
)
...
func (s BoilerStatus) Valid() bool {
	switch s {
	case BoilerStatusStopped, BoilerStatusStarting, BoilerStatusRunning, BoilerStatusFiringDown, BoilerStatusIdle:
		return true
	}
	return false
}
